...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_sphere()
      sphere_volume_result = sphere_volume( 2 )
      assert_equal( 33.51, sphere_volume_result )
  end

  #You can add your own converters
   def test_fahrenheit_to_celsius()
     f_to_c_convert_result = f_to_c_convertor(100)
     assert_equal(37.78, f_to_c_convert_result)
   end
